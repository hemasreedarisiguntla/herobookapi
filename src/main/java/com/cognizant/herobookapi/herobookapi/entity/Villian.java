...
public class Villian {
    ...
    public Villian(String archRival, String image, String realName, String heroName, double height, double weight, String specialPower, String intelligence, Integer strength, Integer power, Integer speed, Boolean agility, String description, String story) {
